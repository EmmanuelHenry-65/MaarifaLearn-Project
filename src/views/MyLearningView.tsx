...
type SubjectStyle = { icon: string; iconColor: string; barColor: string; cardTint: string };
...
const DEFAULT_STYLE: SubjectStyle = { icon: '📘', iconColor: 'bg-slate-500/10 border-slate-500/20 text-slate-400', barColor: 'bg-gradient-to-r from-slate-500 to-slate-400', cardTint: 'from-slate-500/20 to-slate-600/10' };

const styleFor = (subjectCode: string) => SUBJECT_STYLES[subjectCode] ?? DEFAULT_STYLE;
